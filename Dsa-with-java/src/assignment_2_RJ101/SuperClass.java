 ...
 * System.out.println("rectangle.area= " + rectangle.getArea());
 * 
 * Cuboid cuboid = new Cuboid(5,10,5); System.out.println("cuboid.width= " +
 * cuboid.getWidth()); System.out.println("cuboid.length= " +
 * cuboid.getLength()); System.out.println("cuboid.area= " + cuboid.getArea());
